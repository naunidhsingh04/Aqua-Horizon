"""
AQUA HORIZON — Model 4: ResNet + BiLSTM
...
from ml.models_hybrid import ResNetBiLSTM
from ml.data_loader import load_sequence_data

def train_resnet___bilstm():
    print("=" * 80)
    print("AQUA HORIZON — HYBRID MODEL 4: RESNET + BILSTM")
    print("Architecture Class: ResNetBiLSTM")
    print("=" * 80)
    ...
    best_f1 = 0.0
    best_metrics = None
    save_path = os.path.join(os.path.dirname(__file__), 'models', 'resnet_bilstm.pt')
    ...
    # Save metrics JSON
    metrics_path = os.path.join(os.path.dirname(__file__), 'models', 'resnet_bilstm_metrics.json')
    with open(metrics_path, 'w') as f:
        json.dump(best_metrics, f, indent=2)
        
    print("-" * 80)
    print("TRAINING COMPLETE FOR RESNET + BILSTM!")
